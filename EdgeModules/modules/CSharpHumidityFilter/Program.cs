namespace CSharpHumidityFilter
{
    using System;
    ...
    class Program
    {
        ...
        /// us that the desired properties have been changed. If a property 'Humidity'
        ///  is found, we take its value and assign it to our humidityFilter variable.
        /// </summary>
        static Task OnDesiredPropertiesUpdate(TwinCollection desiredProperties, object userContext)
        {
            try
            {
                ...
                if (desiredProperties["Humidity"] != null)
                {
                    humidityFilter = desiredProperties["Humidity"];
                }
            }
        ...
        /// </summary>
        static async Task<MessageResponse> FilterHumidityMessage(Message message, object userContext)
        {
